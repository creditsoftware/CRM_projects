...
if ($result->num_rows > 0) {
 ...
 <td><div class="status"> '.$row['emailaddress'].' </div></td>						 
 <td><div class="status"> Administrator </div></td>						 
  	...
  	<td><div class="status"> '.$row['date'].'<br>'.$row['time'].' </div></td>						 
						 ...
						 <br>
						  <button onclick="deactivete()" class="btn bs-tooltip    btn-danger btn-round btn-xs" title="Block User">
