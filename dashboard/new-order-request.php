...
if ($result->num_rows > 0) {
 ...
 <td><div class="status">Date: <u>'.$row['order_date'].'</u>
 <br>Time: <u>'.$row['order_time'].'</u>
 </div></td>						 
  						 
								  
							  <td>
						 <button onclick="deactivete('.$row['order_id'].')"  class="btn    bs-tooltip rounded  btn-success btn-round btn-xs" title="Join Order">
